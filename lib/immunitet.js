...
import {PatternProcessors, PatternProcessorAliases} from './patterns/string_patterns';

const ProcessorHandlers = {
    'string': createStringPatternProcessor(PatternProcessors, PatternProcessorAliases),
