...
import {processNumber, NUMBER_PROCESSORS} from './number_processors';
import {STRING_PROCESSORS} from './string_processors';
import {BOOLEAN_PROCESSORS} from './boolean_processors';
...
export const PATTERN_PROCESSORS = {
    ...
    'string': (value, processors) => {
        ...
        if (STRING_PROCESSORS[processors])
            value = STRING_PROCESSORS[processors](value);
    ...
    'boolean': (value, processors) => {
        ...
        if (BOOLEAN_PROCESSORS[processors])
            value = BOOLEAN_PROCESSORS[processors](value);
