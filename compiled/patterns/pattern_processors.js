...
var getProcessorNFlag = function getProcessorNFlag(pattern) {
    var flag = undefined;
    ...
    if (pattern[pattern.length - 2] === '/') {
        ...
        if (!flag) throw new _exceptions.ImmunitetException('Supplied regexp pattern flag is not supported.');
...
var processRegexp = exports.processRegexp = function processRegexp(value, pattern) {
    var _getProcessorNFlag = getProcessorNFlag(pattern),
